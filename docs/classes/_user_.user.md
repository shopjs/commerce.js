...
*Defined in [User.ts:22](https://github.com/shopjs/commerce.js/blob/5aef636/src/User.ts#L22)*
...
*Defined in [User.ts:16](https://github.com/shopjs/commerce.js/blob/5aef636/src/User.ts#L16)*
...
*Defined in [User.ts:19](https://github.com/shopjs/commerce.js/blob/5aef636/src/User.ts#L19)*
