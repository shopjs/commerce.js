(function (global, factory) {
    ...
    (global = global || self, factory(global['@ecomv3/document'] = {}, global.crypto));
    ...
    */
    ...
    var Interaction = /** @class */ (function () {
         ...
         */
        function Interaction(ref, refAt) {
            if (ref === void 0) { ref = SYSTEM_REF; }
            if (refAt === void 0) { refAt = new Date(); }
            this.interactorRef = ref;
            // handle Firestore case
            if (refAt) {
                if (refAt._seconds) {
                    this.interactedAt = new Date(refAt._seconds * 1000 + Math.floor(refAt._nanoseconds / 1000000));
                }
                else {
        ...
        __decorate([
            observable
        ], Interaction.prototype, "interactorRef", void 0);
        __decorate([
            observable
        ], Interaction.prototype, "interactedAt", void 0);
        return Interaction;
    }());

    var DocumentRef = /** @class */ (function () {
        function DocumentRef(id, path) {
            if (id === void 0) { id = ''; }
            if (path === void 0) { path = ''; }
            this.id = id;
            this.path = path;
        ...
        __decorate([
            observable
        ], DocumentRef.prototype, "id", void 0);
        __decorate([
            observable
        ], DocumentRef.prototype, "path", void 0);
        return DocumentRef;
    }());
    /**
    ...
    var Document = /** @class */ (function () {
         ...
         */
        Document.prototype.newId = function (collectionPath, uid) {
            if (collectionPath === void 0) { collectionPath = '/'; }
            if (uid === void 0) { uid = nanoid(); }
            this._ref.path = collectionPath + '/' + uid;
            this._ref.id = uid;
            return this._ref.id;
        };
        Object.defineProperty(Document.prototype, "uid", {
            /**
             * Return the uid
        ...
        Object.defineProperty(Document.prototype, "env", {
            /**
        ...
        Object.defineProperty(Document.prototype, "namespace", {
            /**
        ...
        __decorate([
            observable
        ], Document.prototype, "created", void 0);
        __decorate([
            observable
        ], Document.prototype, "updated", void 0);
        __decorate([
            observable
        ], Document.prototype, "deleted", void 0);
        __decorate([
            computed
        ], Document.prototype, "id", null);
        __decorate([
            computed
        ], Document.prototype, "uid", null);
        __decorate([
            computed
        ], Document.prototype, "path", null);
        __decorate([
            computed
        ], Document.prototype, "env", null);
        __decorate([
            computed
        ], Document.prototype, "namespace", null);
        __decorate([
            computed
        ], Document.prototype, "collection", null);
        __decorate([
            computed
        ], Document.prototype, "raw", null);
        return Document;
    }());
    var z = new Document();
